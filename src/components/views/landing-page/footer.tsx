      ...
      <Container>
        <div className="m-auto md:w-10/12 lg:w-8/12 xl:w-6/12">
          <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
            <div className="flex w-full justify-center space-x-12 text-muted-foreground dark:text-gray-300 sm:w-7/12 md:justify-start">
            ...
            <div className="m-auto mt-16 w-10/12 space-y-6 text-center sm:mt-auto sm:w-5/12 sm:text-left">
              ...
              <span className="flex justify-between text-muted-foreground dark:text-white">
              ...
              <span className="block text-gray-500 dark:text-gray-400">
                ...
                <a
                  href="#"
                  className="font-semibold text-muted-foreground dark:text-white"
                >
                  {" "}
                  Contact Us
                </a>
