...
export default function Stats() {
  return (
    <div id="solution" className="pt-6">
      <Container>
        <div className="flex-row-reverse justify-between space-y-6 text-muted-foreground md:flex md:gap-6 md:space-y-0 lg:items-center lg:gap-12">
          ...
          <div className="md:7/12 lg:w-1/2">
            <h2 className="h1 to-brand-700 dark:from-brand-700 dark:via-brand-600 dark:to-brand-400 bg-gradient-to-br from-gray-800 bg-clip-text font-bold text-transparent dark:text-white lg:font-bold">
              Elevating Your Team&apos;s Potential
            </h2>
            <p className="my-8 text-muted-foreground dark:text-gray-300">
