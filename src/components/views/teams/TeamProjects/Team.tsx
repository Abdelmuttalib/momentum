...
export default function Team({ team }: TeamProps) {
  ...
  return (
    <Link
      href={projectLink}
      className="dark:hover:border-brand-300 hover:border-primary-100 hover:bg-primary-100/20 hover:bg-primary-50 group relative flex flex-col justify-between rounded-lg border-2 border-gray-200 hover:border-gray-800 dark:border-gray-800 dark:bg-gray-800/50 dark:bg-gray-900"
    >
...
export function TeamLoader() {
  return (
    <div className="hover:bg-primary-50 flex flex-col justify-between rounded-lg border-2 border-gray-200 bg-popover hover:border-gray-800 dark:border-gray-800 dark:bg-gray-900">
      <div className="flex h-10 w-full items-center rounded-t-lg bg-gray-100 px-4 dark:bg-gray-800/30 dark:text-gray-200">
        <div className="flex items-center gap-2">
          <UsersIcon className="w-5" />
        ...
        <div className="inline-flex items-center gap-x-3">
          <Avatar className="h-8 w-8">
            <AvatarImage
              ...
              alt={name}
            />
            <AvatarFallback className="h-8 w-8 rounded-full bg-gradient-to-br from-primary to-primary/50"></AvatarFallback>
          </Avatar>
