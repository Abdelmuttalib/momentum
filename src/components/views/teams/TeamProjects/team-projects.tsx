                ...
                >
                  <div className="flex items-center justify-between gap-2">
                    <div>
                      ...
                      <div className="body-sm flex items-center text-muted-foreground">
...
export const teamProjectsColumns: ColumnDef<Project>[] = [
  {
    accessorKey: "id",
    header: "id",
  },
...

  {
    ...
    header: "Created Date",
    cell: ({ row: { original } }) => {
      return <span>{formatFullDate(original.createdAt)}</span>;
    },
  },
];
