...

{
  /* <Typography
            ...
            className="bg-gradient-to-br from-foreground to-primary-900 bg-clip-text text-transparent dark:bg-gradient-to-br dark:from-primary-100 dark:to-gray-800 dark:bg-clip-text dark:text-transparent lg:tracking-tighter"
          >
            Momentum
          </Typography>
                ...
                <>
                  ...
                  >
                    <div className="inline-flex items-center gap-x-2 ">
                      {status === "backlog" && (
                        <CircleDashed className="h-[18px] w-[18px] text-foreground-light" />
                      )}
                      {status === "todo" && (
                        <Circle className="h-[18px] w-[18px] text-foreground-light" />
                      )}
                      {status === "in progress" && (
                        <Radius className="h-[18px] w-[18px] text-foreground-light" />
                      )}
                      {status === "done" && (
                        <CheckCircle2 className="h-[18px] w-[18px] text-foreground-light" />
                      )}
                      <Typography
                        as="h3"
                        variant="sm/medium"
                      ...
                      >
                        ...
                        <Badge
                          color="white"
                          className="ml-4 rounded border border-border p-1 px-1.5 text-xs text-current dark:bg-layer"
                        >
                      ...
                      {(provided, snapshot) => (
                        <div
                          className={`h-full space-y-4 rounded ${
                            snapshot.isDraggingOver ? "bg-primary-100/30" : ""
                          }`}
                            ...
                            >
                              {(provided) => (
                                <div
                                  ...
                                  ref={provided.innerRef}
                                  className="flex flex-col gap-y-2 rounded border border-border bg-layer p-3 py-3"
                                >
