...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed bottom-0 right-0 z-50 flex h-4/5 w-full max-w-md flex-col gap-4 overflow-y-auto border bg-background px-3 py-2 pb-20 shadow-lg duration-200 dark:bg-gray-900 sm:top-0 sm:h-full sm:rounded-l-lg md:w-full md:px-6",
        className
      )}
      {...props}
    >
