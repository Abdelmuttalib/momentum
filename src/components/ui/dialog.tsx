...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      "data-[state=closed]:animate-out data-[state=closed]:fade-out data-[state=open]:fade-in fixed inset-0 z-50 bg-gray-900 bg-opacity-30 backdrop-blur-sm transition-all duration-100",
      className
    )}
    {...props}
  />
